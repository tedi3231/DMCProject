<%@ Page Language="C#" AutoEventWireup="true" CodeFile="importFileForBlack.aspx.cs"
    Inherits="importFileForBlack" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table style="width: 500px;">
                <tr>
                    <th colspan="2">
                        <asp:Literal ID="ltType" runat="server"></asp:Literal></th>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <span style="color: Red">
                            <asp:FileUpload ID="fileImport" runat="server" /></span></td>
                </tr>
                <tr>
                    <td colspan="2">
