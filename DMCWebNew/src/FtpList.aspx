<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FtpList.aspx.cs" Inherits="src_FtpList" %>
            ...
            <tr>
                ...
                <td valign="top">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
                            ...
                            <td height="25px">
                                <table width="100%" height="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="gainsboro">
                                    <tr>
                                        ...
                                        <td width="100" bgcolor="#efefef" align="center">
                                            服务器IP</td>
                                        <td align="center" bgcolor="#efefef" width="50">
                                            访问类型</td>
                                        <td width="15" bgcolor="#efefef" align="center">
                                            <img id="imgTopCursor" src="images/up.gif" border="0" class="hand" onclick="ChangeDisplay();" /></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateColumn HeaderText="用户名&密码">
                                                <ItemTemplate>
                                                    ...
                                                    <%# createTitle(DataBinder.Eval(Container.DataItem, "vLogin"),DataBinder.Eval(Container.DataItem, "vPwd"),DataBinder.Eval(Container.DataItem, "vSiteName"))%>                                                 
                                                    </asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                        ...
                        <tr id="trBottom">
                            <td height="120px">
                                <iframe src="FtpInfo.aspx" id="frmContent" name="frmContent" scrolling="no" frameborder="0"
