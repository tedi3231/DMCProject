<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HttpList.aspx.cs" Inherits="src_HttpList" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
        <tr>
            ...
            <td valign="top">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
                    <tr id="trTop">
                        <td height="50px" valign="top" bgcolor="gainsboro">
                                ...
                                <asp:DataGrid ID="dtgData" runat="server" AutoGenerateColumns="False" BackColor="White"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderText="被访问网站">
                                            <ItemTemplate>
                                                <asp:Label ID="LabelURL" runat="server" Width="350" CssClass="hidoverflow"><%# DataBinder.Eval(Container.DataItem, "vURL").ToString()%></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                    </Columns>
