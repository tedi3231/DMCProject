<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BlackWhiteEmailKeyWord.aspx.cs"
    Inherits="src_BlackWhiteEmailKeyWord" %>

<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<%@ Register src="control/IssuedControl.ascx" tagname="IssuedControl" tagprefix="uc1" %>
<html>
<head id="Head1" runat="server">
    <title>邮件黑名单列表管理</title>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function showParentWin() {
            var url = ""; //定义弹出窗口的URL   
            var model = ""; //定义弹出窗口样式   
            oWindow = window.open('AddBlackEmail.aspx', 'newwindow', 'height=350, width=500, top=100, left=200, toolbar=no, menubar=no, scrollbars=no, resizable=no,location=n o, status=no');
            //注意下面才是重点   
            if (!listen_started) {
        ...
        function showUpdateWin(id) {
            var url = ""; //定义弹出窗口的URL   
            var model = ""; //定义弹出窗口样式   
            oWindow = window.open('UpdateBlackEmail.aspx?id=' + id, 'newwindow', 'height=120, width=500, top=100, left=200, toolbar=no, menubar=no, scrollbars=no, resizable=no,location=n o, status=no');
            //注意下面才是重点   
            if (!listen_started) {
                setTimeout(refreshSelf, 1000);
            }
        ...
        function refreshSelf() {
            if (!oWindow.closed) {
                ...
                form.action = "BlackWhiteEmailKeyWord.aspx";
                form.submit();
            }
        }   
    </script>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td align="center" valign="middle" class="title" height="40">
                                        邮件黑名单列表 <a href='searchBlack.aspx'>返回</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top" align="center" height="330">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="1" width="90%">
                                            <tr>
                                                ...
                                                <td width="50" style="width: 50px; text-align: right; margin-right: 5px;">
                                                    <div align="right">
                                                        类型：</div>
                                                </td>
                                                <td width="100">
                                                    <asp:DropDownList ID="DropDownList1" runat="server" Width="100px">
                                                        ...
                                                        <asp:ListItem Value="0">邮箱黑名单</asp:ListItem>
                                                        <%--<asp:ListItem Value="1">白邮箱</asp:ListItem>--%>
                                                    </asp:DropDownList>
                                                </td>
                                                <td width="50">
                                                ...
                                                <td width="80">
                                                    <asp:Button ID="btImport" runat="server" OnClientClick="window.open('importFileForBlack.aspx?type=3');"
                                                        Text="导入导出" />
                                                </td>
                                                <td>
                                                
                                                    <uc1:IssuedControl ID="IssuedControl1" runat="server" DataType="3" />
                                                
                                                </td>
                                                <td width="60">
                                                    <asp:LinkButton ID="lbClearWhite" runat="server" OnClientClick="return confirm('您确定要清空所有白Email吗？');"
                                                        CommandArgument="2" OnClick="lbClearWhite_Click" Visible="false">清空所有白邮箱</asp:LinkButton>
                                                </td>
                                                <td width="180">
                                                    <asp:LinkButton ID="lbClearBlack" runat="server" OnClientClick="return confirm('您确定要清空所有黑Email吗？');"
                                                        CommandArgument="0" OnClick="lbClearBlack_Click">清空所有邮箱黑名单</asp:LinkButton>
                                                </td>
                                            </tr>
                                            <tr>
                                                    <td colspan="11">
