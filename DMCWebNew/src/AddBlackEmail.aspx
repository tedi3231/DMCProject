<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddBlackEmail.aspx.cs" Inherits="src_AddBlackEmail" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>新建黑Email</title>
             ...
             <tr>
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <td><span style="color:Red">多Email输入(注意:每行只能输入一个Email)</span></td>
                </tr>
                  <tr>
                    <td colspan="2">
