<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MsnList.aspx.cs" Inherits="src_MsnList" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
        <tr>
            ...
            <td valign="top">
                ...
                <tr>
                    ...
                    <table width="100%" height="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="gainsboro">
                        <tr>
                            ...
                            <td width="150" bgcolor="#efefef" align="center">发送方邮箱</td>
                            <td width="150" bgcolor="#efefef" align="center">接收方邮箱</td>
                            <td width="30" bgcolor="#efefef" align="center">类型</td>
                        ...
                        <asp:DataGrid ID="dtgData" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#EFEFEF" BorderStyle="Solid" BorderWidth="1px" CellPadding="0" DataKeyField="ID" PageSize="250" Width="100%" OnItemDataBound="dtgData_ItemDataBound" ShowHeader="False">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="内容">
                                    <ItemTemplate>
                                        <asp:Label ID="LabelMessage" runat="server" Width="330px" CssClass="hidoverflow"><%# DataBinder.Eval(Container.DataItem, "vMessage").ToString()%></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                ...
                                <asp:TemplateColumn HeaderText="接收方邮箱">
                                    <ItemTemplate>
                                        <asp:Label ID="LabelMailTo" runat="server" CssClass="hidoverflow" Width="150px"><%# DataBinder.Eval(Container.DataItem, "vMailTo").ToString()%></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle Width="150px" />
                                </asp:TemplateColumn>
                ...
                <tr id="trBottom">
                    <td height="120px">
                    <iframe src="MsnInfo.aspx" id="frmContent" name="frmContent" scrolling="no" frameborder="0" width="100%" height="120px">
                    </iframe>
                    </td>
                </tr>
                </table>
