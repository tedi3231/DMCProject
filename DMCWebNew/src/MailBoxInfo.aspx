<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MailBoxInfo.aspx.cs" Inherits="src_mailboxinfo" %>
...
<head id="Head1" runat="server">
    ...
    function DoOnload()
    {
        EmailPath = "DownLoad.aspx?filename=<%=getServerFile()%>";
        if (EmailPath != "")
        {
    ...
    function OpenFile()
    {
        ...
        if (EmailPath != "")
        {
            window.location.href=EmailPath;
...
<body onload="DoOnload();">
    <form id="form1" runat="server">
        <table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0">
            <tr>
                <td align="center" style="width: 353px">
                    <div style="width: 345px; height: 100%; overflow: auto;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtmapadd" runat="server" ReadOnly="true" BorderColor="#A9A9A9"
                                        BackColor="#efefef" BorderStyle="Solid" BorderWidth="1" Width="200"></asp:TextBox>
                                    <img id="showEmail" src="images/list3.gif" border="0" onclick="OpenFile();" style="visibility: hidden" /></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox  BorderColor="#A9A9A9"
                                        BackColor="#efefef" BorderStyle="Solid" BorderWidth="1" runat="server" ID="ltArea" Width="220" TextMode="multiLine" Height="70px"></asp:TextBox>
                ...
                <td>
                    <iframe id="frmEmail" src="<%=emlFile%>" name="frmEmail" frameborder="0" scrolling="auto"
