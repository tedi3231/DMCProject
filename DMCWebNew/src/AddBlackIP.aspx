<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddBlackIP.aspx.cs" Inherits="src_AddBlackIP" %>
            ...
            <table style="width:500px;">
             <tr>
                ...
                <tr>
                  ...
                  <tr>
                    <td style="width: 40px">I   P：</td>
                    <td><span style="color:Red">多IP输入(注意:每行只能输入一个IP)</span></td>
                </tr>
                  <tr>
                    <td colspan="2">
