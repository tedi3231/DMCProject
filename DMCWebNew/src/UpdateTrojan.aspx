<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateTrojan.aspx.cs" Inherits="UpdateTrojan" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table style="width:500px;">
             <tr>
                    <th colspan="2">更新木马特征码</th>
                </tr>
                <tr>
                    <td style="width:80px;">木马名称:</td>
                    <td>
                        <asp:TextBox ID="tbName" runat="server" Width="200px" ReadOnly="true"></asp:TextBox>   
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <asp:RadioButtonList ID="rblFlag" runat="server" RepeatDirection="Horizontal">
                            <asp:ListItem Value="0">出</asp:ListItem>
                            <asp:ListItem Value="1">进</asp:ListItem>
