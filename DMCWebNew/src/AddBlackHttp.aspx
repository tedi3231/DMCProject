<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddBlackHttp.aspx.cs" Inherits="src_AddBlackIP" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>新建HTTP黑名单</title>
            ...
            <table style="width:500px;">
             <tr>
                ...
                <tr>
                  ...
                  <tr>
                    <td style="width: 40px">HTTP：</td>
                    <td><span style="color:Red">多HTTP输入(注意:每行只能输入一个HTTP)</span></td>
                </tr>
                  <tr>
                    <td colspan="2">
                        <asp:TextBox ID="tbName" runat="server" Height="200px" TextMode="MultiLine" Width="500px"></asp:TextBox></td>                   
                </tr>
                <tr>
                    <td>
