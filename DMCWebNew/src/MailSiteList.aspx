<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MailSiteList.aspx.cs" Inherits="src_MailSiteList" %>
        ...
        <tr>
            ...
            <td valign="top">
                        ...
                        <tr>
                            ...
                            <td rowspan="2">
                                <asp:RadioButtonList ID="rdlMailType" runat="server" RepeatDirection="Vertical" RepeatLayout="Flow">
                                    <asp:ListItem Value="Get">收信</asp:ListItem>
                                    <asp:ListItem Value="Send" Selected="True">发信</asp:ListItem>
                                </asp:RadioButtonList>
                            </td>
                            <td rowspan="2">
                            ...
                            <td rowspan="2" class="btquery"><asp:Button ID="btnSearch" runat="server" Text="查询" OnClick="btnSearch_Click" />
                            <asp:Button ID="btnDelete" runat="server" Text="删除所选记录" OnClick="btnDelete_Click" OnClientClick="return confirm('是否真的要删除这些记录？')" />
                            <a href="queryattach.aspx" target="_blank" style="display:none">查询附件</a></td>
                            <td>&nbsp;<asp:Button ID="btnPrev" runat="server" Text="上一封" OnClick="btnPrev_Click" /></td>
                        </tr>
                        <tr>
                            <td>到</td>
                            <td>
                            ...
                            <td>&nbsp;<asp:Button ID="btnNext" runat="server" Text="下一封" OnClick="btnNext_Click" />
                            <asp:HiddenField ID="hidRow" runat="server" Value="0" /></td>
                        </tr>
                    </table>
                    </td>
                </tr>
                <tr>
                    ...
                    <table width="100%" height="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="gainsboro">
                        <tr>
                            ...
                            <td width="30" bgcolor="#efefef" align="center">附件</td>
                            <td bgcolor="#efefef" align="center">主题</td>
                            <td width="120" bgcolor="#efefef" align="center">时间</td>
                            <td width="100" bgcolor="#efefef" align="center">用户IP地址</td>
                            <td width="140" bgcolor="#efefef" align="center">发件人</td>
                            <td width="120" bgcolor="#efefef" align="center">收件人</td>
                            <td width="15" bgcolor="#efefef" align="center"><img runat="server" id="imgTopCursor" src="images/up.gif" border="0" class="hand" onclick="ChangeDisplay();"/></td>
                        </tr>
                    </table>
                    </td>
                </tr>
                        ...
                        <asp:DataGrid ID="dtgData" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#EFEFEF" BorderStyle="Solid" BorderWidth="1px" CellPadding="0" DataKeyField="ID" PageSize="250" Width="100%" OnItemDataBound="dtgData_ItemDataBound" ShowHeader="False">
                            ...
                            <asp:TemplateColumn HeaderText="编号" Visible="true">
                                ...
                                <asp:TemplateColumn HeaderText="发件人">
                                    <ItemTemplate>
                                        <asp:Label ID="LabelMailFrom" runat="server" CssClass="hidoverflow" Width="140px"><%# Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "vLpFrom").ToString())%></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle Width="140px" />
                                </asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="收件人">
                                    <ItemTemplate>
                                        <asp:Label ID="LabelMailTo" runat="server"  CssClass="hidoverflow" Width="120px"><%# Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "vLpTo").ToString())%></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle Width="120px" />
                                </asp:TemplateColumn>
                             </Columns>
                ...
                <tr>
                    ...
                    <iframe runat="server" src="mailSiteinfo.aspx" id="frmContent" name="frmContent" scrolling="no" contenteditable="true" frameborder=no width="100%" height="100%">
                    </iframe>
                    </td>
                </tr>
                </table>
