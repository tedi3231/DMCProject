<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KeyUser.aspx.cs" Inherits="src_KeyUser" %>
...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%" background="images/bg.jpg"
        class="bg">
        <tr>
            <td style="width: 2px; cursor: e-resize; background-color: #6D9EDB; height: 546px;">
            </td>
            <td valign="top" align="center" style="height: 546px">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td align="center" valign="middle" class="title" height="40">
                            敏感信息关键字列表 <a href='searchBlack.aspx'>返回</a>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" align="center" height="330">
                            ...
                            <table border="0" cellpadding="0" cellspacing="1" width="640">
                                <tr>
                                    <td align="left">
                                        列出类别为<asp:DropDownList ID="ddlCate" runat="server" DataSourceID="odsCategory" DataTextField="vCategory"
                                            DataValueField="nId" AutoPostBack="True" OnSelectedIndexChanged="ddlCate_SelectedIndexChanged"
                                            OnDataBound="ddlCate_DataBound">
                                        </asp:DropDownList>
                                        的关键字
                                    </td>
                                    <td align="right">
                                        <a onclick="openWindow('Category.aspx?type=2')" style="text-decoration: underline;
                                            color: Blue; cursor: hand;">敏感信息类别管理</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                            ...
                            <table border="0" cellspacing="1" cellpadding="0" bgcolor="gainsboro">
                                <tr>
                                    <td width="20" bgcolor="#efefef">
                                        <input id="CheckAll" runat="server" onclick="DoSelectAll();" title="全选/全取消" type="checkbox">
                                    </td>
                                    ...
                                    <td width="120" bgcolor="#efefef" align="center">
                                        ...
                                        <asp:Button ID="btnAdd" runat="server" Text="新增记录" OnClick="btnAdd_Click" Width="120px" />
                                    </td>
                                </tr>
                            </table>
                            <asp:GridView ID="dtgData" runat="server" AutoGenerateColumns="False" OnRowDataBound="dtgData_RowDataBound"
                                DataKeyNames="nId" BorderStyle="Solid" BorderWidth="1px" PageSize="20" OnRowCancelingEdit="dtgData_RowCancelingEdit"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="敏感信息">
                                        <ItemTemplate>
                            ...
                            <table runat="server" id="tblAddNew" visible="false" border="0" cellspacing="1" cellpadding="0"
                                ...
                                <tr>
                                    <td width="20" bgcolor="gainsboro">
                                        <img src="images/cursor.gif" visible="false">
                                    </td>
                                    <td width="200" bgcolor="#DCDCDC">
                                    ...
                                    <td width="300" bgcolor="gainsboro">
                                        <asp:TextBox ID="txtNewKey" runat="server" Width="300px"></asp:TextBox>
                                    </td>
                                    <td bgcolor="gainsboro" width="60">
                                    </td>
                                    <td bgcolor="gainsboro" align="center" style="width: 120px">
                            ...
                            <uc1:IssuedControl ID="IssuedControl1" runat="server" DataType="4" />
                            ...
                            <asp:Button ID="btnCheckAll" runat="server" Text="比对所有关键字" OnClick="btnCheckAll_Click"
                                Visible="false" />
                            <asp:Button ID="btnExportKey" runat="server" Text="导出敏感信息关键字" OnClick="btnExportKey_Click" />
                            <asp:FileUpload ID="fileImport" runat="server" />
                            <asp:Button ID="btnImportKey" runat="server" Text="导入敏感信息关键字" OnClick="btnImportKey_Click" />
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <asp:ObjectDataSource ID="odsCategory" runat="server" SelectMethod="listCategories"
        TypeName="dbConfig">
        <SelectParameters>
            <asp:Parameter DefaultValue="2" Name="nType" Type="String" />
        </SelectParameters>
