<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FtpInfo.aspx.cs" Inherits="src_FtpInfo" %>
...
<body topmargin="0" leftmargin="0" style="margin:0 0 0 0 ; padding:0 0 0 0 ;">
    ...
    <table align="center" cellpadding="0" cellspacing="0" border="0">
        ...
        <tr>
            ...
            <td style="width: 225px">
                <asp:TextBox ID="txtSrcAddr" runat="server" ReadOnly="true" BorderColor="#A9A9A9"
                    BackColor="#efefef" BorderStyle="Solid" BorderWidth="1" Width="150"></asp:TextBox>
                <asp:Button ID="Button2" runat="server" OnClick="Button1_Click" Text="归属地" Width="65px" />
            </td>
            <td width="120px">
                &nbsp;&nbsp;服务器IP地址：
            </td>
            <td style="width: 223px">
                <asp:TextBox ID="txtDstAddr" runat="server" ReadOnly="true" BorderColor="#A9A9A9"
                    BackColor="#efefef" BorderStyle="Solid" BorderWidth="1" Width="150"></asp:TextBox>
                <asp:Button ID="Button1" runat="server" OnClick="Button1_Click1" Text="归属地" Width="65px" />
            </td>
        </tr>
        <tr>
            <td width="90px">
        ...
        <tr>
            ...
            <td style="width: 225px">
                <asp:TextBox ID="txtFilePath" runat="server" ReadOnly="true" BorderColor="#A9A9A9" BackColor="#efefef"
                    BorderStyle="Solid" BorderWidth="1" Width="150"></asp:TextBox>
            </td>
            <td width="120px">
                &nbsp;&nbsp;文件大小：
            ...
            <td style="width: 223px">
                <asp:TextBox ID="txtFileSize" runat="server" ReadOnly="true" BorderColor="#A9A9A9" BackColor="#efefef"
                    BorderStyle="Solid" BorderWidth="1" Width="150"></asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3">
                ...
                <asp:TextBox BorderColor="#A9A9A9" BackColor="#efefef" BorderStyle="Solid" BorderWidth="1"
                    runat="server" ID="ltArea" Width="630px"></asp:TextBox>
            </td>
        </tr>
