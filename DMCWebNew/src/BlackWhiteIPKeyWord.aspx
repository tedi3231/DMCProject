<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BlackWhiteIPKeyWord.aspx.cs"
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function showParentWin() {
            var url = ""; //定义弹出窗口的URL   
            var model = ""; //定义弹出窗口样式   
            oWindow = window.open('AddBlackIP.aspx', 'newwindow', 'height=350, width=500, top=100, left=200, toolbar=no, menubar=no, scrollbars=no, resizable=no,location=n o, status=no');
            //注意下面才是重点   
            if (!listen_started) {
        ...
        function showUpdateWin(id) {
            var url = ""; //定义弹出窗口的URL   
            var model = ""; //定义弹出窗口样式   
            oWindow = window.open('UpdateBlackIP.aspx?id=' + id, 'newwindow', 'height=120, width=500, top=100, left=200, toolbar=no, menubar=no, scrollbars=no, resizable=no,location=n o, status=no');
            //注意下面才是重点   
            if (!listen_started) {
                setTimeout(refreshSelf, 1000);
            }
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td align="center" valign="middle" class="title" height="40">
                                        IP黑名单列表 <a href='searchBlack.aspx'>返回</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top" align="center" height="330">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="1" width="90%">
                                            <tr>
                                                <td width="60" style="width: 60px; text-align: right; margin-right: 5px;">
                                                    IP地址：
                                                </td>
                                                <td width="100">
                                                ...
                                                <td width="100">
                                                    <asp:DropDownList ID="DropDownList1" runat="server" Width="100px">
                                                        ...
                                                        <asp:ListItem Value="0"> IP黑名单</asp:ListItem>
                                                ...
                                                <td>
                                                    <uc1:IssuedControl ID="IssuedControl1" runat="server" DataType="2" />
                                                </td>
                                                <td width="60">
                                                    <asp:LinkButton ID="lbClearWhite" runat="server" CommandArgument="2" OnClientClick="return confirm('您确定要删除所有白IP吗？');"
                                                        Visible="false" OnClick="lbClearWhite_Click">清空所有白IP</asp:LinkButton>
                                                </td>
                                                <td width="180">
                                                    <asp:LinkButton ID="lbClearBlack" runat="server" CommandArgument="0" OnClientClick="return confirm('您确定要删除所有IP黑名单吗？');"
                                                        OnClick="lbClearBlack_Click">清空所有黑IP</asp:LinkButton>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="11">
