<%@ Page Language="C#" AutoEventWireup="true" CodeFile="changeDNSDnsList.aspx.cs"
    Inherits="src_changeDNSDnsList" %>
...
<body>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False">
        <Columns>
            ...
            <asp:TemplateField HeaderText="域名个数">
                <ItemTemplate>
                    <%#Eval("dnsCount")%>
                </ItemTemplate>
            </asp:TemplateField>
