<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QQList.aspx.cs" Inherits="src_QQList" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
        <tr>
            ...
            <td valign="top">
                ...
                <tr id="trBottom">
                    <td height="80px">
                    <iframe src="QQInfo.aspx" id="frmContent" name="frmContent" scrolling="no" frameborder="0" width="100%" height="80px">
                    </iframe>
                    </td>
                </tr>
                </table>
