<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WebList.aspx.cs" Inherits="src_WebList" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
        <tr>
            ...
            <td valign="top">
                ...
                <tr>
                    ...
                    <table width="100%" height="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="gainsboro">
                        <tr>
                            ...
                            <td bgcolor="#efefef" align="center" width="360">内容</td>
                            <td width="85" bgcolor="#efefef" align="center">用户网卡地址</td>
                            <td width="90" bgcolor="#efefef" align="center">用户IP</td>
                            <td width="90" bgcolor="#efefef" align="center">服务器IP</td>
                    ...
                    <td>
                        ...
                        <asp:DataGrid ID="dtgData" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#EFEFEF" BorderStyle="Solid" BorderWidth="1px" CellPadding="0" DataKeyField="ID" PageSize="250" Width="100%" OnItemDataBound="dtgData_ItemDataBound" ShowHeader="False">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="站点&用户名&密码">
                                    <ItemTemplate>
                                        <asp:Label ID="LabelContent" runat="server" Width="360px" CssClass="hidoverflow">站点：<%# DataBinder.Eval(Container.DataItem, "vsitename")%> | 用户名：<%# DataBinder.Eval(Container.DataItem, "vLogin")%> | 密码：<%# DataBinder.Eval(Container.DataItem, "vPwd")%></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                ...
                <tr id="trBottom">
                    <td height="140px">
                    <iframe src="WebInfo.aspx" id="frmContent" name="frmContent" scrolling="no" frameborder="0" width="100%" height="130px">
                    </iframe>
                    </td>
                </tr>
                </table>
